...
## Structure
- `AdminPanel/Config.lua` — tweak command prefix, admin UserIds, AI backend, and theme colors.
...
- `AdminPanel/ClientUI.lua` — local UI panel script with black + blue styling for quick command entry.
...
## Highlights
- **200+ commands** across moderation, movement, audio, effects, and world presets.
- **AI integration** via `ai <prompt>` calling your configured HTTP endpoint.
- **Black/blue UI** with quick-run button and log feed.
